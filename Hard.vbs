...
' Hard difficulty
        ...
        'find last row in percent change column
        Dim percentChangeLastRow As Long
        percentChangeLastRow = Cells(Rows.Count, 11).End(xlUp).Row
        ...
        'create variables to compare values
        Dim greatestInc As Double
        Dim greatestDec As Double
        Dim greatestTotVol As Variant
        
        'create variables to hold ticker values
        ...
        greatestTotVol = ws.Range("L2").Value

        For iRow = 3 To percentChangeLastRow
            If ws.Range("K"&iRow).Value < greatestInc Then
                If ws.Range("K"&iRow).Value < greatestDec Then
                    greatestDec = ws.Range("K"&iRow).Value
                    greatestDecTicker = ws.Range("I"&iRow).Value
                End If
            ElseIf ws.Range("K"&iRow).Value > greatestInc Then
                greatestInc = ws.Range("K"&iRow).Value
                greatestIncTicker = ws.Range("I"&iRow).Value
            End If

            If ws.Range("L"&iRow).Value > greatestTotVol Then
                greatestTotVol = ws.Range("L"&iRow).Value
                greatestTotVolTicker = ws.Range("I"&iRow).Value
            End If
        ...
        ws.Range("P4").Value = greatestTotVolTicker
